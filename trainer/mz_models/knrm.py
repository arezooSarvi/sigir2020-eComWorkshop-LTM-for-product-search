...
model.params['kernel_num'] = 9
model.params['sigma'] = 0.12
...
mcp_save = keras.callbacks.ModelCheckpoint('best_one_knrm', save_best_only=True, monitor='val_loss', mode='min')
...
print("=========================================================================================================================")
try:
    model.save('KNRM-mode_default_params_early_stop')
except:
    pass
write_predictions_in_test_score_file(test_set_predictions, item_query_ids)

# ---------------------
model.backend.load_weights("best_one_knrm", by_name=True)
test_set_predictions = model.predict(test_x)
