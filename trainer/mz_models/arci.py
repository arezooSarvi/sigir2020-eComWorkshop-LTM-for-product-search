...
model.params['right_pool_sizes'] = [2]
model.params['conv_activation_func']= 'relu'
model.params['mlp_num_layers'] = 2
model.params['mlp_num_units'] = 248
model.params['mlp_num_fan_out'] = 92 
model.params['mlp_activation_func'] = 'relu' 
model.params['dropout_rate'] = 0.12
model.params['optimizer'] = 'adam'
model.params['padding'] = 'causal'
...
mcp_save = keras.callbacks.ModelCheckpoint('best_one_arci', save_best_only=True, monitor='val_loss', mode='min')
...
try:
    model.save('ARCI-model')
except:
    pass
write_predictions_in_test_score_file(test_set_predictions, item_query_ids)

# ---------------------
model.backend.load_weights("best_one_arci", by_name=True)
test_set_predictions = model.predict(test_x)
