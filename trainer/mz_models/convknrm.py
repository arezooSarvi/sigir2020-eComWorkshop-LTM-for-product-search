...
model.params['kernel_num'] = 6
model.params['sigma'] = 0.17
...
mcp_save = keras.callbacks.ModelCheckpoint('best_one_convknrm', save_best_only=True, monitor='val_loss', mode='min')
